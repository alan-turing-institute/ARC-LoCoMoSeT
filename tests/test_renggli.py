...
def test_renggli_perfect_features(dummy_features_perfect, dummy_labels, test_seed):
    """
    Test that the Renggli score is 1 if the features give perfect information
    about the labels.
    """
    assert renggli(dummy_features_perfect, dummy_labels, random_state=test_seed) == 1
